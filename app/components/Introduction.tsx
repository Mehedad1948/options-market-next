...
const StrategyCard = ({
  ...
  <div
    className={`relative group p-8 rounded-3xl border border-slate-200 dark:border-slate-700 ${bgClass} transition-all duration-300 hover:-translate-y-2 hover:shadow-xl`}
  >
    <div
      className={`absolute top-6 left-6 w-14 h-14 rounded-2xl flex items-center justify-center ${colorClass} bg-opacity-20`}
    >
    ...
    <div className='mt-12'>
      ...
      <p className='text-sm font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400 mt-1'>
        {subtitle}
      </p>
      ...
      <div className='container mx-auto px-4 relative z-10'>
        ...
        <div className='max-w-4xl mx-auto text-center mb-20'>
          ...
          <p className='text-lg md:text-xl text-slate-600 dark:text-slate-300 leading-relaxed text-justify md:text-center max-w-3xl mx-auto'>
            ما تلاش نمی‌کنیم آینده را پیش‌بینی کنیم. ما خود را برای آن آماده
            می‌کنیم. این استراتژی بر اساس فلسفه «پاداش نامتقارن» بنا شده است.
            <br className='hidden md:block' />
            ما آگاهانه{' '}
            <strong className='text-slate-800 dark:text-slate-100 bg-slate-200/50 dark:bg-slate-800 px-1 rounded'>
              زیان‌های کوچک و منظم را می‌پذیریم
            </strong>{' '}
            و آن را هزینه‌ی کسب‌وکار می‌دانیم؛ هزینه‌ای ضروری برای اینکه در زمان
            وقوع رویدادهای نادر، در درست‌ترین سمت بازار ایستاده باشیم.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10 max-w-5xl mx-auto mb-24'>
          ...
          <div className='md:mt-12'>
            {' '}
            {/* Offset effect for playful layout */}
            <StrategyCard
