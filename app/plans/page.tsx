...
// Loading Fallback for the Gauge Area
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors duration-300">
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 max-w-5xl">
        ...
        {/* 1. USER METRIC (Streams in) */}
        <Suspense fallback={<GaugeSkeleton />}>
           <UserSubscriptionGauge />
        </Suspense>

        {/* 2. HEADER (Streams in for correct banner logic) */}
        <Suspense fallback={<div className="h-32" />}>
           <PromotionalHeader />
        </Suspense>

        {/* 3. PRICING CARDS (Static - Renders Immediately) */}
...
// --- SHARED COMPONENT: PLAN CARD (Pure Presentational) ---
...
function PlanCard({
    title, price, originalPrice, period, badge, icon, highlight, description, buttonText, isPopular = false, link
}: PlanCardProps) {
    return (
