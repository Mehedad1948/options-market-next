        ...
        <div className='container mx-auto px-4 text-center'>
          ...
          <h1 className='text-5xl md:text-7xl font-black tracking-tight mb-8 leading-tight'>
            <span className='block text-slate-900 dark:text-white mb-2'>
              آپشن‌
              <span className='text-amber-600 dark:text-amber-500'>یار</span>
            </span>
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center max-w-3xl mx-auto mb-16'>
            <h2 className='text-3xl font-bold mb-4 text-slate-900 dark:text-white'>
              چرا معامله‌گران حرفه‌ای آپشن‌یار را انتخاب می‌کنند؟
            </h2>
            <p className='text-slate-600 dark:text-slate-400'>
              پیچیدگی‌های بازار اختیار معامله را با تکنولوژی ترکیب شده‌اند تا
              شما ساده‌تر تصمیم بگیرید.
            </p>
          </div>
          ...
          <div className='grid md:grid-cols-3 gap-8'>
            ...
            <div className='bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md transition-shadow group'>
              ...
              <p className='text-slate-600 dark:text-slate-400 leading-relaxed'>
                الگوریتم‌ها تمام قراردادهای موجود در بازار را در کسری از ثانیه
                اسکن می‌کنند تا بهترین فرصت‌های خرید و فروش را شناسایی کنند.
              </p>
            </div>
            ...
            <div className='bg-white dark:bg-slate-900 p-8 rounded-2xl border border-amber-200 dark:border-amber-900/50 shadow-sm hover:shadow-md hover:shadow-amber-500/10 transition-all group'>
              ...
              <p className='text-slate-600 dark:text-slate-400 leading-relaxed'>
                فرصت‌ها در بازار آپشن به سرعت می‌سوزند. سیگنال‌ها بدون تاخیر از
                طریق تلگرام و داشبورد به دست شما می‌رسد.
              </p>
            </div>
            ...
            <div className='bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md transition-shadow group'>
              ...
              <p className='text-slate-600 dark:text-slate-400 leading-relaxed'>
                علاوه بر نقطه ورود، ما حد ضرر و حد سود را نیز به شما پیشنهاد
                می‌دهیم تا سرمایه شما همیشه در امنیت باشد.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='container mx-auto px-4 relative z-10'>
          <div className='flex flex-col-reverse lg:flex-row items-center justify-between gap-20 lg:gap-20'>
            ...
            <div className='w-full lg:w-6/12 text-right dir-rtl relative'>
              ...
              <h2 className='relative z-10 text-center lg:text-right text-2xl md:text-5xl  font-black leading-12 md:leading-24 text-slate-800 dark:text-slate-100'>
      ...
      <section className='py-24 bg-slate-900 text-white relative overflow-hidden z-10'>
        ...
        <div className='container mx-auto px-4 text-center relative z-10'>
          <h2 className='text-3xl md:text-4xl font-bold mb-6'>
            آماده شروع معاملات <span className='text-amber-500'>هوشمند</span>{' '}
            هستید؟
          </h2>
          ...
          <div className='grid md:grid-cols-4 gap-8 mb-12'>
            <div className='col-span-1 md:col-span-2'>
              ...
              <p className='text-slate-500 text-sm leading-relaxed max-w-sm'>
                اولین پلتفرم جامع تحلیل و سیگنال‌دهی بازار اختیار معامله در
                ایران. ما به شما کمک می‌کنیم تا با دید باز معامله کنید.
              </p>
            </div>
